# FEAT-002: Governed Feed Publication Lifecycle
...
downstream:
  - ../11_tasks/TASK-002-design-governed-feed-publication-lifecycle.md
related_adrs:
...
Make feed generation and exposure pass through explicit lifecycle, validation, status, and observability controls.
...
Roadmap `../08_roadmap/ROADMAP.md`; milestone `../09_milestones/MS-002-feed-publication-foundation.md`; system `../04_systems/SYS-001-feed-generation.md`; task `../11_tasks/TASK-002-design-governed-feed-publication-lifecycle.md`.
