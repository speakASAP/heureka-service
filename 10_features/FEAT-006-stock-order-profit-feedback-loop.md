# FEAT-006: Stock Order Profit Feedback Loop
...
downstream:
  - ../11_tasks/TASK-006-plan-stock-order-profit-feedback-loop.md
related_adrs:
...
Plan read-only ecosystem feedback so feed inclusion reflects availability, demand, and profitability without ownership drift.
...
Roadmap `../08_roadmap/ROADMAP.md`; milestone `../09_milestones/MS-005-stock-order-profit-feedback.md`; system `../04_systems/SYS-001-feed-generation.md`; task `../11_tasks/TASK-006-plan-stock-order-profit-feedback-loop.md`.
